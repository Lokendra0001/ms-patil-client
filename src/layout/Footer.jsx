...
const Footer = () => {
  ...
  const coreServices = [
    { name: "Road & Highway Bypass", href: "/services" },
    { name: "Institutional Complexes", href: "/services" },
    { name: "Ready Mix Concrete (RMC)", href: "/services" },
    { name: "Stone Aggregate Crushers", href: "/services" },
    { name: "Fly Ash Brick Manufacture", href: "/services" },
  ];
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col gap-5 w-full">
              <div className="flex items-start gap-3">
                <svg className="w-4 h-4 text-primary-light-hover shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center gap-3">
                <svg className="w-4 h-4 text-primary-light-hover shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.94.725l.548 2.2a1 1 0 01-.321.988l-1.305.98a10.582 10.582 0 004.872 4.872l.98-1.305a1 1 0 01.988-.321l2.2.548a1 1 0 01.725.94V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+919876543210" className="text-xs sm:text-sm text-slate-600 hover:text-primary-light-hover transition-colors duration-200 font-semibold">
                  +91 98765 43210
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@mspatilconstruction.com" className="text-xs sm:text-sm text-slate-600 hover:text-primary-light-hover transition-colors duration-200 font-semibold break-all">
