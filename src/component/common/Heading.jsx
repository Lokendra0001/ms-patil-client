...
const Heading = ({
  ...
  if (layout === "split") {
    return (
      <div
        className={`flex flex-col lg:flex-row lg:items-end justify-between gap-4 border-b border-slate-100 pb-10 mb-10 lg:mb-16  ${alignClass} ${className}`}
      >
        ...
        {description && (
          <p className="text-slate-600 lg:max-w-md leading-relaxed text-sm sm:text-base">
            {description}
          </p>
        )}
      </div>
