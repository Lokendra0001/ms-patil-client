...
const Leadership = () => {
  return (
    <section className="w-full bg-slate-50 py-20 lg:py-24 border-t border-b border-border-secondary relative overflow-hidden select-text">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="xl:col-span-5 relative flex justify-center">
            ...
            <div className="relative w-full max-w-sm aspect-[4/5] overflow-hidden z-10 border border-border-secondary rounded-tl-[100px] rounded-br-[100px] rounded-tr-[20px] rounded-bl-[20px] shadow-sm bg-white-background">
              <Image
                src={ceo}
          ...
          <div className="xl:col-span-7 flex flex-col items-start">
           ...
           Under the direct leadership of Shri Chetankumar Bhagwan Suryawanshi, the enterprise has scaled operations to execute key state highway corridors, railway line alignments, and vertically integrated civil infrastructure works.
            </p>
              ...
              {credentials.map((card, idx) => {
                const getIcon = () => {
                  switch (idx) {
                    case 0:
                      return (
                        <Factory className="w-5 h-5 text-primary-hover group-hover:text-primary transition-colors duration-300" />
                      );
                    case 1:
                      return (
                        <Hammer className="w-5 h-5 text-primary-hover group-hover:text-primary transition-colors duration-300" />
                      );
                    case 2:
                      return (
                        <Train className="w-5 h-5 text-primary-hover group-hover:text-primary transition-colors duration-300" />
                      );
                    default:
                      return null;
                  }
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="w-10 h-10 bg-slate-50 border border-slate-100 flex items-center justify-center rounded-none group-hover:bg-primary/15 group-hover:border-primary/10 transition-colors duration-300">
                          {getIcon()}
                        </div>
                      </div>

                      <h4 className="text-sm font-extrabold text-text-primary mb-1.5 transition-colors duration-300 group-hover:text-primary-hover">
                        {card.title}
                      </h4>
