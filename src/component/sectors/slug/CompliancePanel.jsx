      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {data.compliance.map((item, idx) => (
            <div
              key={idx}
              className="bg-white border border-border-secondary rounded-none p-6 sm:p-8 space-y-4 hover:border-border-primary transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.01)] relative group"
            >
              {/* Gold Top Border Hover Line */}
              <div className="absolute top-0 left-0 right-0 h-[3px] bg-transparent group-hover:bg-primary-light transition-all duration-300" />
