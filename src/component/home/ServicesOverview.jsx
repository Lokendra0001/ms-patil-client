        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 border border-slate-200">
          {primaryServices.map((service, idx) => (
            <Link
              ...
              className="relative overflow-hidden bg-white px-8 py-20 lg:py-24 transition-all duration-500 cursor-pointer flex flex-col justify-between h-[350px] md:h-[450px] group border-b lg:border-b-0 lg:border-r border-slate-200 last:border-r-0 last:border-b-0"
            >
              ...
              <span className="absolute right-6 top-6 text-7xl font-black text-slate-100/90 group-hover:text-white/5 transition-colors duration-500 select-text z-10">
                {service.num}
              </span>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                {/* Top content */}
                <div>
                  <span className="text-[10px] font-black tracking-widest text-primary-light-hover group-hover:text-primary-light transition-colors duration-300 block mb-6 select-text">
                    SERVICE // {service.num}
                  </span>
                ...
                <span className="text-xs font-black tracking-widest uppercase text-slate-900 group-hover:text-primary-light transition-colors duration-300 inline-flex items-center gap-1.5 mt-8 select-text">
                  Explore Service{" "}
