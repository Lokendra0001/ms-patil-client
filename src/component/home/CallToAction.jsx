        ...
        <div className="relative w-full bg-slate-50/50 border border-slate-200/60 p-8 sm:p-12 lg:p-16 overflow-hidden shadow-[0_24px_70px_rgba(15,23,42,0.015)]">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-8 flex flex-col items-start">
              ...
              <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 bg-primary-light/10 text-primary-light-hover rounded-none mb-6 border border-primary-light/10 select-none">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-extrabold text-primary leading-tight tracking-tight mb-5 max-w-3xl">
                Ready to bring your next infrastructure <span className="text-primary-light-hover">landmark</span> to life?
              </h2>

              {/* Standard yellow accent line */}
              <div className="w-16 h-1 bg-primary-light mb-6 select-none" />
              
              {/* Description body */}
              <p className="text-xs sm:text-sm text-slate-500 font-semibold leading-relaxed mb-8 max-w-2xl">
                From highway bypass corridors and municipal complexes to automated concrete manufacturing plants, M/S Chetankumar Bhagwan Suryawanshi provides end-to-end PWD contracting solutions engineered to last.
              </p>
              ...
              <div className="flex flex-wrap gap-4 w-full">
                ...
                <div className="flex items-center gap-4 bg-white/80 backdrop-blur-sm p-4 border border-slate-200/50 shadow-[0_4px_20px_rgba(0,0,0,0.005)] hover:border-primary-light/50 transition-all duration-300 group/phone min-w-[280px]">
                  ...
                  <div>
                    <div className="text-[9px] uppercase tracking-wider text-slate-400 font-black">Call Our Office</div>
                    <div className="text-sm font-extrabold text-slate-800 group-hover/phone:text-primary-light-hover transition-colors duration-300">+91 98765 43210</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-white/80 backdrop-blur-sm p-4 border border-slate-200/50 shadow-[0_4px_20px_rgba(0,0,0,0.005)] hover:border-primary-light/50 transition-all duration-300 group/email min-w-[280px]">
                  ...
                  <div>
                    <div className="text-[9px] uppercase tracking-wider text-slate-400 font-black">Email Us</div>
                    <div className="text-sm font-extrabold text-slate-800 group-hover/email:text-primary-light-hover transition-colors duration-300">info@mspatilconstruction.com</div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 w-full flex flex-col items-center lg:items-end justify-center">
              <div className="w-full max-w-sm flex flex-col gap-4">
                <Button
                  ...
                  variant="theme"
                  size="lg"
                  className="w-full uppercase tracking-wider py-4 h-auto select-none"
                >
                  Book a Consultation
                </Button>
              ...
              <div className="mt-4 flex items-center gap-2 text-[10px] text-slate-400 font-bold tracking-wide uppercase select-none">
                <svg className="w-3.5 h-3.5 text-primary-light-hover" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
