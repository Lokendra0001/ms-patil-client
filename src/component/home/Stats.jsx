...
const AnimatedCounter = ({ target, duration = 1800, prefix = "", suffix = "" }) => {
...
const LogoItem = ({ name, icon }) => (
  <div className="flex items-center gap-2.5 text-slate-400 opacity-65 hover:opacity-95 transition-opacity duration-200">
    {icon}
    <span className="font-bold text-sm tracking-wider uppercase select-none">{name}</span>
  </div>
);
  ...
  return (
    <section className="w-full bg-white py-16 sm:py-20 border-b border-slate-100 select-text">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="relative w-full overflow-hidden pb-16 border-b border-slate-100 select-none">
          {/* Gradient Masks */}
          ...
          <div className="flex w-max gap-16 items-center animate-marquee">
            ...
            <div className="flex gap-16 items-center shrink-0 pr-8">
              <LogoItem name="BUILDERIPSUM" icon={<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></svg>} />
              <LogoItem name="APEX_INFRA" icon={<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="9" /><rect x="14" y="3" width="7" height="5" /><rect x="14" y="12" width="7" height="9" /><rect x="3" y="16" width="7" height="5" /></svg>} />
              <LogoItem name="GLOBALGRID" icon={<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" /><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10zM2 12h20" /></svg>} />
              <LogoItem name="HEXAGON_CIVIL" icon={<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" /></svg>} />
              <LogoItem name="SECUREBUILD" icon={<svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>} />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-16 items-center">
          ...
          <div className="lg:col-span-8 flex flex-col items-start">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-primary leading-tight max-w-3xl select-text">
              ...
              <span className="text-primary-light-hover">completed landmarks</span> that stand
              the test of time.
            </h2>
