...
//     image: rmChemical,
//     description:
//       "Executed comprehensive industrial civil structures, heavy foundations, and heavy-duty concrete flooring zones. Mobilized a dedicated concrete supply line from our own computerized 30-CUM/hr RMC plant to achieve precision surface flatness and superior structural stability under strict quality controls.",
//     highlights: [
...
//     image: indo1,
//     description:
//       "Delivered comprehensive industrial site grading, heavy concrete framing, and specialized surface drainage conduits. Implemented subgrade stabilization and engineered sub-base courses to easily support high-volume heavy logistics transport and prevent waterlogging around chemical storage bays.",
//     highlights: [
...
//     image: arihant1,
//     description:
//       "Constructed the core manufacturing unit shell, structural building frames, and heavy-duty industrial interior ground slabs. Engineered reinforced concrete wall panels designed for severe weather resilience alongside complete exterior security masonry enclosure boundaries.",
//     highlights: [
...
//     image: indo3,
//     description:
//       "Engineered heavy-duty foundation blocks, monolithic columns, and rigid Trimix concrete flooring zones for aggressive chemical environments. Utilizing specialized protective coatings and anti-corrosive chemical admixtures, the foundations were designed with vibration-isolation joints to handle heavy processing agitators.",
//     highlights: [
...
//     image: indPhos1,
//     description:
//       "Expanded multi-state operations by delivering high-specification structural concrete frameworks and specialized deep raft foundations to support heavy raw mineral processing assemblies. Mobilized heavy machinery across state lines to execute massive, continuous concrete pours to ensure zero cold joints.",
//     highlights: [
...
//     image: sbd1,
//     description:
//       "Completed full-scale greenfield civil site development solutions, including high-volume bulk grading, deep trenching, and primary structural interfaces. Leveraged high-accuracy grading instruments and lime-stabilized subgrade preparation to optimize load-bearing capacities for the heavy-haul industrial roadway network.",
//     highlights: [
...
export const projectsData = [
  ...
  // ==========================================
  {
    ...
    image: rmChemical,
    description:
      "Executed comprehensive industrial civil structures, heavy foundations, and heavy-duty concrete flooring zones. Mobilized a dedicated concrete supply line from our own computerized 30-CUM/hr RMC plant to achieve precision surface flatness and superior structural stability across M5 to M40 mix designs.",
    highlights: [
      "Heavy-duty RCC industrial shed foundation structural pedestals",
      "Expansive specialized concrete factory interior flatwork flooring",
      "Engineered earthwork excavation and structural backfill compaction",
  ...
  },
  {
    ...
    image: indo1,
    description:
      "Delivered comprehensive industrial civil works, heavy RCC structural framing, and specialized factory surface drainage conduits at MIDC Dhule. Implemented precision foundation grading, bulk cutting, and subgrade backfilling to support high-volume manufacturing logistics and secure chemical storage bays.",
    highlights: [
      "Heavy RCC structural frames, columns, and industrial equipment foundations",
      "Precision site excavation, rock cutting, and engineered murum backfilling",
      "Integrated chemical facility stormwater drainage layout networks and slab drains",
      "Heavy-traffic interlocking paver installation for facility courtyard pathways",
    ],
    gallery: [indo1, indo2, indo3],
  },
  {
  ...
  },
  {
    ...
    highlights: [
      "Water-tight concrete lining for irrigation distribution channels",
      "Precision canal earthwork profile profile cutting and side-slope grading",
      "Structural RCC control chambers and agricultural flow check walls",
      "Effective rural erosion management setups along distribution paths",
    ],
    gallery: [irrigation1, irrigation2],
  },
  {
    id: "21",
    title: "MJP Urban Water Supply Infrastructure",
  ...
  },
  {
    ...
    image: gavpl3,
    description:
      "Delivered comprehensive agro-industrial facility civil works for Godrej Agrovet, incorporating high-precision industrial processing shed foundations, bulk grading, and durable surface pavements. The project included casting high-strength loading dock walls, concrete ramp accesses, and silo foundations designed for massive static loads. Continuous concrete feed lines were supported directly by our specialized mobile batching trucks, ensuring on-demand supply across high-grade M5-M40 specifications.",
    highlights: [
      "Heavy-load equipment concrete foundations and steel pedestal bases",
      "Expansive industrial campus grading, drainage, and terrain leveling",
      "High-finish rigid concrete sorting yards and vehicle transit pavements",
